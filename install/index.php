    ...
    <div class="container">
                ...
                <div class="container">
                    ...
                    <div class="navbar-collapse bs-navbar-collapse collapse">
                        <ul class="nav navbar-nav">
                            <li class="active"><a href="#home" data-toggle="tab"><?php echo __("Install")?></a></li>
                            <li><a href="http://market.open-eshop.com/faq/" target="_blank"><?php echo __("FAQ")?></a></li>
                            <li><a href="#requirements" data-toggle="tab"><?php echo __("Requirements")?></a></li>
                            <li><a href="#about" data-toggle="tab"><?php echo __("About")?></a></li>
                        </ul>
        ...
        <div class="tab-content">
            <div class="tab-pane fade in active" id="home">
                <?php install::view($view)?>
            </div>
            <div class="tab-pane fade" id="requirements">
                <?php install::view('requirements')?>
            </div>
            <div class="tab-pane fade" id="about">
                <?php install::view('about')?>
            </div>
        </div>
        ...
        <footer>
            <p>
            &copy;  <a href="http://open-eshop.com" title="Open Source PHP digital goods">Open eShop</a> 2013 - <?php echo date('Y')?>
            </p>
        </footer>
    </div> 
