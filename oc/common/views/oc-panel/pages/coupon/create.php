	...
	<div class="col-md-12">
		<div class="panel panel-default">
			<div class="panel-body">
                ...
                <hr>
                <form action="<?php echo Route::url('oc-panel', array('controller'=> 'coupon', 'action'=>'create')) ?>" method="post" accept-charset="utf-8" class="form form-horizontal" enctype="multipart/form-data">   
                
                <div class="form-group ">
                    <div class="col-sm-12">
                        <label for="name" class="control-label"><?php echo __('Coupon Name')?></label>        
                ...
                <div class="form-group ">
                    <div class="col-sm-12">
                        ...
                        <input type="text" id="number_coupons" name="number_coupons" value="1" />                           
                    </div>
                </div>
