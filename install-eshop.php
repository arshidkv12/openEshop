...
class install{
    ...
    public static function requirements()
    {
        ...
        return     array(
                ...
                'openssl'   =>array('message'   => 'Install requires the <a href="https://www.php.net/manual/en/book.openssl.php">openssl</a> for the Encrypt class.',
                                    'mandatory' => TRUE,
...
<head>
    ...
    <meta name="copyright" content="Open eShop <?php echo install::VERSION?>" >
    ...
    <div class="container">
        <div class="navbar navbar-fixed-top navbar-inverse">
         ...
         <a class="logo" target="_blank" href="http://open-eshop.com">
            <img src="http://open-eshop.com/wp-content/themes/strappress-eshop/img/logo.png" width="249" height="45" alt="Open eShop <?php echo __("Installation")?>">
        </a>    
            ...
            <div class="tab-pane fade in active" id="home">
                ...
                {?>
                    ...
                    <div class="page-header">
                        <h1>Install Open eShop v.<?php echo $last_version;?></h1>
                ...
                ?>
                    <hr>
                    <h3><?php echo __("Software Requirements")?>  v.<?php echo $last_version;?></h3>
                    <p><?php echo __('Requirements checks we do before we install.')?> 
        ...
        <footer>
            <p>
            &copy;  <a href="http://open-eshop.com" title="Open eShop PHP">Open eShop</a> 2013 - <?php echo date('Y')?>
            </p>
        </footer>
    </div> 
...
{
    ?>
    <?php if (!empty(install::$error_msg)):?>
    <br>
    <div class="alert alert-danger"><?php echo install::$error_msg?></div>
    <?php endif?>

    <?php if(!empty(install::$msg)):?>
        <br>
        <div class="alert alert-warning">
            <?php echo __("We have detected some incompatibilities, installation may not work as expected but you can try.")?> <br>
            <?php echo install::$msg?>
        </div>
    <?php endif?>
